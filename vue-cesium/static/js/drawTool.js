const CreatePolyline = require('../../static/js/createPolyline');
const CreateCircle = require('../js/createCircle');
const CreateBillboard = require('../js/createBillboard');
const CreatePolygon = require('../js/createPolygon');
